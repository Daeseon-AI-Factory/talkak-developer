...
fn main() {
    ...
    // Restoring the sessions that were alive when this store was last written belongs to the
    // server, once the endpoint is actually this process's — see `restore_after_binding`.
